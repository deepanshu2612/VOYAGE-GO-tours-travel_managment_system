...
void Tourist::ad_display(){
    ...
    cout<<"-------------------------------------------";
    cout<<"------------------------------------------------------\n";
    cout<<"Sr No.\t\tDEST. CODE\tPLACE\t\tCOUNTRY\t\tDay/Night\t\tPRICES\n";
    cout<<"------------------------------------------------";
    cout<<"-------------------------------------------------\n";
    int c=1;
    while(1){
        ...
        if(fp.eof())break;
       		r=ad_unpack(buff);
        cout<<c++<<"\t\t"<<r.ad_code<<"\t\t"<<r.ad_place<<"\t\t";
        cout<<r.ad_country<<"\t\t" <<r.ad_days<<"\t\t"<<r.ad_prices<<endl;
    }
    fp.close();
    return;
}
...
void Tourist::us_display(){
    ...
    while(1){
        ...
        cout<<"\t\t\t"<<r.us_date<<"\t\t"<<r.us_dcode<<"\t\t"<<r.us_status<<endl;
    }
    fp.close();
    return;
}
...
int main(){
    cout<<"                              \t\t WELCOME TO TOUR AND TRAVEL MANAGMENT SYSTEM\n\n\n";
    cout<<"                                   \t          [ TOURIST RESERVATION ]  \n\n";
